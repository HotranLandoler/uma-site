...
/** 六种菜格类型标识 */
export type TypeKey = "holly" | "lotus" | "carrot" | "apple" | "banana" | "coconut";
...
export const UI = {
	brand: "键盘农场",
	brandSprout: "/caige/stages/stage-2.png",
	brandSproutAlt: "发芽植物",
	...
	copyBtn: "复制结果文案",
	againBtn: "重新测试",
	copySuccess: "已复制结果文案，可以发给朋友了。",
} as const;

/** 并列优先级（高 → 低）：香蕉 ＞ 莲花 ＞ 萝卜 ＞ 椰子 ＞ 冬青 ＞ 苹果 */
export const TIE_ORDER: TypeKey[] = ["banana", "lotus", "carrot", "coconut", "holly", "apple"];

/** 测试题 */
export const QUESTIONS: Question[] = [
	{ q: "周一打开电脑，发现今天的事情比想象中多。你的第一反应是？", a: [
	...
	{ q: "深夜12点，你在做什么？", a: [
		{ t: "再打最后一把游戏！下把赢了肯定去睡！/只看最后一集！我保证看到女主复仇成功了就去睡！", s: { lotus: 2 } },
		{ t: "已经进入梦乡。", s: { carrot: 2 } },
		{ t: "睡不着，脑海里在想前几天自己在同事面前出糗的事。", s: { banana: 2 } },
		{ t: "还在学习/复盘！强者不需要睡觉。", s: { apple: 2 } },
	]},
	{ q: "如果键盘农场能帮你今天顺利一点，你最想要它长出什么？", a: [
		{ t: "🍎 自动冒出Todo List，提醒大家往前走。", s: { apple: 2 } },
		{ t: "🥕每次翻车都记录在便利贴，方便下次避坑。", s: { carrot: 2 } },
		{ t: "🥥更多有趣的物品！比如午后长出一杯让人开心的奶茶。", s: { coconut: 2 } },
		{ t: "🪷记录我每天的成长和工作，帮助我顺利进入盛开状态。", s: { lotus: 2 } },
		{ t: "🌲番茄钟。旁边再热闹，我也能安稳地保持自己的节奏。", s: { holly: 2 } },
		{ t: "🍌更多舒缓的音乐，让我把脑内的小剧场先暂停十分钟。", s: { banana: 2 } },
	]},
];
...
export const TYPES: Record<TypeKey, TypeInfo> = {
	holly: {
		name: "冬青",
		image: "/caige/holly.png",
		relationImage: "/caige/relation-holly.svg",
	...
	lotus: {
		name: "莲花",
		image: "/caige/lotus.png",
		relationImage: "/caige/relation-lotus.svg",
	...
	carrot: {
		name: "萝卜",
		image: "/caige/carrot.png",
		relationImage: "/caige/relation-carrot.svg",
	...
	apple: {
		name: "苹果",
		image: "/caige/apple.png",
		relationImage: "/caige/relation-apple.svg",
	...
	banana: {
		name: "香蕉",
		image: "/caige/banana.png",
		relationImage: "/caige/relation-banana.svg",
	...
	coconut: {
		name: "椰子",
		image: "/caige/coconut.png",
		relationImage: "/caige/relation-coconut.svg",
