...
export const TYPES: Record<TypeKey, TypeInfo> = {
  holly: {
    ...
    desc: "红果满枝，四季常青，只要有你在，即使是寒冬也洋溢着节日般的热闹与欢乐。\n你的爱意外放而舒展，总是保持着一颗分享与支持的心，于是也被相同的爱意环抱。",
    tags: ["同理心", "气氛组", "C位的快乐使者"],
    heroTitle: "TA是你的菜",
    avatarBg: "#d6efd2",
    color: "#3e7f55",
    relations: {
      recommend: [
        { key: "coconut", kind: "recommend" },
        { key: "carrot", kind: "recommend" },
        { key: "lotus", kind: "recommend" },
      ],
    },
  },
  lotus: {
    ...
    desc: "开花是朝九晚五，宗旨是多睡少补，你是花中公务员，有着不可撼动的养生态度。\n你总是淡淡的，好像游离于人群之外。但你只是有自己的社会时钟，不会被浪潮推着走。",
    tags: ["情绪稳定", "感觉要鼠了也是淡淡的", "提醒喝水小助手"],
    heroTitle: "TA是你的菜",
    avatarBg: "#f3d6e3",
    color: "#a64d7a",
    relations: {
      recommend: [
        { key: "apple", kind: "recommend" },
        { key: "coconut", kind: "recommend" },
        { key: "carrot", kind: "recommend" },
      ],
    },
  ...
  carrot: {
    ...
    desc: "都说一个萝卜一个坑，但不知为何，你遇到的是一个一个又一个坑。\n你总是愿意亲自去一探究竟，然后又多了一段黑历史。但在一次次尝试中，你比其他人更了解自我的感受。",
    tags: ["探索精神", "不信邪", "隐藏的内心戏导演"],
    heroTitle: "TA是你的菜",
    avatarBg: "#d8efd3",
    color: "#3e7f55",
    relations: {
  ...
  apple: {
    ...
    desc: "有人说你是世界上最常见、最不起眼的，有人说你是带来智慧与罪恶的，独一无二的。\n他有他们的定义，而你决定创造你自己的答案。你纯粹的内心是鼓舞他人最强大的动力。",
    tags: ["坚定可靠", "务实改变世界", "深藏功与名"],
    heroTitle: "TA是你的菜",
    avatarBg: "#fadbd2",
    color: "#b54a3a",
    relations: {
  ...
  banana: {
    ...
    desc: "传说只要把你挂在高处，就能让你支棱起来续命，但实际情况是你会在生活的重力下自由落体。\n为了追求完美，你总是把自己绷得很紧，但有时候，躺下，才是最适合你的生活哲理。",
    tags: ["高要求", "敏锐观察者", "惊人的爆发力"],
    heroTitle: "TA是你的菜",
    avatarBg: "#fcecc4",
    color: "#b58a2a",
    relations: {
      tense: [{ key: "apple", kind: "tense" }],
      recommend: [
        { key: "coconut", kind: "recommend" },
        { key: "holly", kind: "recommend" },
      ],
    },
  },
  coconut: {
    ...
    desc: "椰子肉，椰子冻，椰子水，椰子鸡……家常食谱两百卷，卷卷都能有椰名。\n你热衷于接触新事物，并且发挥自己的创意做出新东西，你有能把简单的生活过得丰富多彩的超能力。",
    tags: ["有品位", "浪漫美学派", "自由流动的灵魂"],
    heroTitle: "TA是你的菜",
    avatarBg: "#e8dcc4",
    color: "#8b6322",
    relations: {
